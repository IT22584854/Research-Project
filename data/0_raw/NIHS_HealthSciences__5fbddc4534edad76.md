Source URL: https://www.nihs.gov.lk/404.html

ERROR 404 - PAGE NOT FOUND
### [Why am I seeing this page?](https://www.nihs.gov.lk/404.html)
...
### [How to find the correct spelling and folder](https://www.nihs.gov.lk/404.html)
...
#### _Broken Image_
When you have a missing image on your site you may see a box on your page with with a red where the image is missing. Right click on the and choose Properties. The properties will tell you the path and file name that cannot be found.
This varies by browser, if you do not see a box on your page with a red try right clicking on the page, then select View Page Info, and goto the Media Tab.
> http://example.com/cgi-sys/images/banner.PNG
In this example the image file must be in public_html/cgi-sys/images/
Notice that the **CaSe** is important in this example. On platforms that enforce case-sensitivity **PNG** and **png** are not the same locations.
### [404 Errors After Clicking WordPress Links](https://www.nihs.gov.lk/404.html)
...
### [How to modify your .htaccess file](https://www.nihs.gov.lk/404.html)
