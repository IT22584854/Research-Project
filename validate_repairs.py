...
IN_PATH = Path("data/6_curation/validation_gpt5/curation_pool_1000_repaired.jsonl")
OUT_PATH = Path("data/6_curation/validation_gpt5/repaired_validate_batch_input.jsonl")
